...
## 4. REFERENCE PATTERNS (Pseudocode)

<!-- (Required) Provide Pseudocode from the codebase as reference templates. -->
...
```text
/* (Paste the important part of source code for the new file here) */
```

### Task 5.2: Modify Existing File `path/to/existing/file.ext`

<!-- (Required for [MODIFY] files) Provide clear instructions/diff. -->
